			...
			<div class="col-md-7">
				<div class="single-product-details">
					...
					<div class="product-category">
						...
						<ul>
							<li><a href="/pages/product-single">Products</a></li>
							<li><a href="/pages/product-single">Soap</a></li>
						</ul>
					</div>
					<a href="/pages/cart" class="btn btn-main mt-20">Add To Cart</a>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="/pages/product-single">Reef Boardsport</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="/pages/product-single">Rainbow Shoes</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="/pages/product-single">Strayhorn SP</a></h4>
						<p class="price">$230</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="/pages/product-single">Bradley Mid</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
